...
export default function Home() {
  return (
    <div>
      <Head>
        <title>ThreadAura </title>
        <meta name='description' content='Unveil Your Unique Aura.' />
      </Head>

      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto">
          <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Discover Your Unique Style with ThreadAura</h1>
            <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Elevate your wardrobe with our exclusive collection of t-shirts, crafted for comfort and designed to stand out. From bold prints to minimalist designs, ThreadAura has the perfect tee for every vibe.</p>
          </div>
